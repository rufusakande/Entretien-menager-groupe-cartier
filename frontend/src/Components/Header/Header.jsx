...
import './Header.css';
import logo from '../../assets/Images/logo_entretient_menager.webp';
      ...
      <nav className="main-nav">
        <div className="container">
          <div className="logo" onClick={() => handleMenuClick('accueil')}>
            <img 
              src={logo} 
              alt="Entretien Ménager Groupe Cartier - Logo" 
              className="logo-image"
            />
            <div className="logo-text">
              <span className="company-name">ENTRETIEN MÉNAGER</span>
